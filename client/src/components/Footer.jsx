export default function Footer() {
  ...
  return (
    <>
      <footer 
        className="bg-tv-bg border-t border-tv-borderSubtle py-2 md:py-4 px-4 md:px-6 mt-auto md:mb-0 fixed left-0 right-0 z-20 shadow-sm md:relative md:bottom-auto"
        style={{ 
